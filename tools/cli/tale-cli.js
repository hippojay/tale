...
const packageName = 'tale-framework';
...
async function checkForUpdate() {
  try {
    ...
    if (result && result !== packageJson.version) {
      ...
      console.warn(`  ║    npm cache clean --force && npx tale-framework@${tag} install                  ║`);
      console.warn('  ║                                                                               ║');
      console.warn('  ╚═══════════════════════════════════════════════════════════════════════════════╝');
      console.warn('');
    }
...
// Set up main program
program.version(packageJson.version).description('TALE Core CLI - Universal AI agent framework');
